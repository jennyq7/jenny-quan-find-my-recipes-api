...
exports.index = async (req, res) => {
    await axios.get('https://platform.fatsecret.com/rest/server.api?method=recipes.search.v2&format=json&max_results=50', {
        headers: {
            Authorization: "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjVGQUQ4RTE5MjMwOURFRUJCNzBCMzU5M0E2MDU3OUFEMUM5NjgzNDkiLCJ0eXAiOiJhdCtqd3QiLCJ4NXQiOiJYNjJPR1NNSjN1dTNDeldUcGdWNXJSeVdnMGsifQ.eyJuYmYiOjE2ODM1ODA3NzcsImV4cCI6MTY4MzY2NzE3NywiaXNzIjoiaHR0cHM6Ly9vYXV0aC5mYXRzZWNyZXQuY29tIiwiYXVkIjoiYmFzaWMiLCJjbGllbnRfaWQiOiI3Njk3NWEzYzNmZTI0N2QyOTkxZGE4ZjEwNmM4YzhiZiIsInNjb3BlIjpbImJhc2ljIl19.LW7Tk--TBhTFTTUClUDOa35OycKpwooRCb7RxiGKBHeBcQ21NW6jnooYLPYSREUzH0-nGnfEtj2DGzHQesnqHCPRXDpK-_lzGwiq_si7NOVbq0sH3_gaDtpFR4-XeECGKL58OI_vDup75ASephymi6mT10MatWBclL1VjvYB2FDsOdMDBVarPdJZiZ3cTogvUaSUHwdRIUl9ju_LAPHBKX6DAwOJn6-9xlPc9Phg4s8TXdvCd3u4XeFWAvxXTrvEimo3aavmlkf2iXwLILD7mgjepOXRt1MX-e6ws-q39_VErw7bptmuLiH4JCd-GPmKZe_6MsE6gM22KcBwMM75dw"
        } }
            ).then(response => {
...
exports.addRecipe = async (req, res) => {
    ...
    try {
        ...
        let servedURL = 'recipe-box-app.azurewebsites.net' + servedFilePath;
