...
exports.index = async (req, res) => {
    await axios.get('https://platform.fatsecret.com/rest/server.api?method=recipes.search.v2&format=json&max_results=50', {
        headers: {
            Authorization: "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjVGQUQ4RTE5MjMwOURFRUJCNzBCMzU5M0E2MDU3OUFEMUM5NjgzNDkiLCJ0eXAiOiJhdCtqd3QiLCJ4NXQiOiJYNjJPR1NNSjN1dTNDeldUcGdWNXJSeVdnMGsifQ.eyJuYmYiOjE2NzkzMjgxMjIsImV4cCI6MTY3OTQxNDUyMiwiaXNzIjoiaHR0cHM6Ly9vYXV0aC5mYXRzZWNyZXQuY29tIiwiYXVkIjoiYmFzaWMiLCJjbGllbnRfaWQiOiI3Njk3NWEzYzNmZTI0N2QyOTkxZGE4ZjEwNmM4YzhiZiIsInNjb3BlIjpbImJhc2ljIl19.Vsz-xcAHbj1DPObuq3WzLv_omqYtS89C5u2BdQmaxRQI1V0qjzlgCE5-qDksOFgwxta6VrvYoZ8B0SRS_OCBI17pBVf-R0wh_8MAaPsDWAkda10QVzC3IGDx-O9orUVIBtl4rBsEsvgxTX8VaqFxgWFx15j7VGvq0g7Qf0b4aHDQu_YKkb0FVer3mtTGBR501GXu1xxsAgyeADUFPVny8yDnz21mNzwISEY2QLBJVIl7YNEfr7fsjLks8P3h17ZqSrLet0QIRJuRAMLp2PPvI4zSAp231uV6O5pW1PI2nF9Y_I7GGiBd9O9i8b568BDngjfSWntpKedDWcye95_YqQ"
        }
    }
    ).then(response => {
